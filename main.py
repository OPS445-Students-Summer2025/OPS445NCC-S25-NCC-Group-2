...
import datetime
import sys
from userinput import parse_args # custom user CLI
from backup import full_backup, incremental_backup, file_manifest, manifest_timestamper # backup helping functions
from assignment2 import restore_backup # restore function
from comp2 import compress_from_manifest # compression function
from logfile import log_operation # logging function
...
def main():
    ...
    source = args.source # user specified source
    destination = args.destination # user specified destination
    ...
    if mode == "backup":
        ...
        compressed = compress_from_manifest(manifest_path, output_path)
        if compressed:
